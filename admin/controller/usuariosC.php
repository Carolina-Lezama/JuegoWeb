...
class BuscarController {
    public function buscar() {
        ...
        if ($resultado) {
            ...
            header('Location: view/menu.php');//redirige a otra pagina después de iniciar sesión correctamente.
            exit;
        } else {
            echo "<script>alert('Usuario/Contraseña incorrectos'); window.history.back();</script>";
        }
    }
}
